...
const PERSONALITY = {
  AFRP: {
    ...
    motto:
      "在现实世界中，抽象是事物的本质。了解本质，你将能够构建更强大、更高效的系统。  ——佚名",
  ...
  AFRC: {
    ...
    motto: `"在后端工程中，抽象是构建可维护系统的基石。快速开发和卓越的代码质量共同构成了优秀的后端工程。" - 未知`,
  ...
  AFQP: {
    ...
    motto: `"在数据分析领域，抽象和质量是数据科学的两大支柱。高性能的数据处理为深度分析提供了有力支持。" - 未知`,
  ...
  AFQC: {
    ...
    motto: `"在后端架构中，抽象是系统设计的基石。高质量的代码和良好的可读性共同构成了优秀的后端架构。" - 未知`,
  ...
  AERP: {
    ...
    motto: `"在算法竞赛中，抽象思维是解决问题的关键。快速、高效的算法实现是取得优势的秘诀。" - 未知`,
  ...
  AERC: {
    ...
    motto: `"在数据挖掘领域，抽象和探索是发现隐藏信息的关键。快速而清晰的代码实现助力于更有效的数据挖掘。" - 未知`,
  ...
  AEQP: {
    ...
    motto: `"在系统优化中，抽象思维是提升性能的关键。优质的代码和高性能的系统共同构成了卓越的系统优化师。" - 未知`,
  ...
  AEQC: {
    ...
    motto: `"年轻的后端开发者是技术进步的推动者。抽象思维和高质量的代码是构建未来系统的基石。" - 未知`,
  ...
  VFRP: {
    ...
    motto: `"游戏开发者是创造虚拟世界的艺术家。形象生动的视觉效果和高性能是游戏开发的核心追求。" - 未知`,
  ...
  VFRC: {
    ...
    motto: `"前端CI/CD专家是构建高效前端工作流的引领者。形象生动的界面和可靠的持续集成是前端开发的核心。" - 未知`,
  ...
  VFQP: {
    ...
    motto: `"游戏优化师是创造令人惊艳游戏体验的魔术师。高质量的画面和出色的性能是游戏优化的终极目标。" - 未知`,
  ...
  VFQC: {
    ...
    motto: `"前端架构师是构建可靠前端系统的建筑师。高质量的代码和出色的架构是前端开发的基石。" - 未知`,
    advantage: `前端创造力： 具备出色的前端创意，能够设计出引人入胜的交互界面。
    熟悉前端模式： 对前端开发的常用模式和工具有深入了解，能够高效开发前端应用。
  ...
  VERP: {
    ...
    motto: `"全栈工程师是技术的探险家，同时是前后端的建筑师。快速开发和高质量的代码是全栈开发的标志。" - 未知`,
  ...
  VERC: {
    ...
    motto: `"前端工程师是创造用户与网站之间桥梁的艺术家。迅速交付和可读性高的代码是前端开发的核心。" - 未知`,
  ...
  VEQP: {
    ...
    motto: `"可视化工程师是信息传达的艺术家，通过视觉呈现复杂数据。高质量的可视化效果和优化的性能是可视化工程师的追求。" - 未知`,
  ...
  VEQC: {
    ...
    motto: `"前端框架开拓者是前端技术的创新者，通过框架的开发推动前端领域的发展。高质量的代码和卓越的可视化效果是前端框架开拓者的目标。" - 未知`,
